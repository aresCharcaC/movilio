...
class RideRepositoryImpl implements RideRepository {
  ...
  Future<RideRequest> createRideRequest(RideRequest request) async {
    try {
      developer.log(
        '🔄 Creando solicitud de viaje en el repositorio...',
      ...
      developer.log(
        '✅ Solicitud de viaje creada exitosamente en el repositorio',
        name: 'RideRepositoryImpl',
      );
      return result;
    } on ApiException catch (e) {
      developer.log(
        '❌ Error en el repositorio: ${e.message}',
        name: 'RideRepositoryImpl',
      );
      rethrow;
    }
  ...
  Future<RideRequest> getRideRequest(String id) async {
    try {
      developer.log(
        '🔍 Obteniendo detalles del viaje $id en el repositorio...',
        name: 'RideRepositoryImpl',
      );

      final result = await _remoteDataSource.getRideRequest(id);
      developer.log(
        '✅ Detalles del viaje obtenidos exitosamente en el repositorio',
        name: 'RideRepositoryImpl',
      );
      return result;
    } on ApiException catch (e) {
      developer.log(
        '❌ Error al obtener detalles del viaje: ${e.message}',
        name: 'RideRepositoryImpl',
      );
      rethrow;
    }
  ...
  Future<List<RideRequest>> getActiveRideRequests() async {
    try {
      developer.log(
        '📋 Obteniendo viajes activos en el repositorio...',
        name: 'RideRepositoryImpl',
      );

      final result = await _remoteDataSource.getActiveRideRequests();
      developer.log(
        '✅ ${result.length} viajes activos obtenidos en el repositorio',
        name: 'RideRepositoryImpl',
      );
      return result;
    } on ApiException catch (e) {
      developer.log(
        '❌ Error al obtener viajes activos: ${e.message}',
        name: 'RideRepositoryImpl',
      );
      rethrow;
    }
  ...
  Future<void> cancelRideRequest(String id) async {
    try {
      developer.log(
        '❌ Cancelando viaje $id en el repositorio...',
        name: 'RideRepositoryImpl',
      );

      await _remoteDataSource.cancelRideRequest(id);
      developer.log(
        '✅ Viaje cancelado exitosamente en el repositorio',
        name: 'RideRepositoryImpl',
      );
    } on ApiException catch (e) {
      developer.log(
        '❌ Error al cancelar viaje: ${e.message}',
        name: 'RideRepositoryImpl',
      );
      rethrow;
    }
  ...
  Future<void> cancelAndDeleteActiveSearch() async {
    try {
      developer.log(
        '🗑️ Cancelando y eliminando búsqueda activa en el repositorio...',
        name: 'RideRepositoryImpl',
      );

      await _remoteDataSource.cancelAndDeleteActiveSearch();
      developer.log(
        '✅ Búsqueda activa eliminada exitosamente en el repositorio',
        name: 'RideRepositoryImpl',
      );
    } on ApiException catch (e) {
      developer.log(
        '❌ Error al eliminar búsqueda activa: ${e.message}',
        name: 'RideRepositoryImpl',
      );
      rethrow;
    }
